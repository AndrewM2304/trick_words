  ...
  return (
    <div className={styles.tandc}>
      <p>
        ...
        of www.trickwords.com's Website, located at www.trickwords.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use www.trickwords.com if you do not
      ...
      <p>
        We employ the use of cookies. By accessing www.trickwords.com, you
        agreed to use cookies in agreement with the www.trickwords.com's Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, www.trickwords.com and/or its licensors own the
        intellectual property rights for all material on www.trickwords.com. All
        intellectual property rights are reserved. You may access this from
        www.trickwords.com for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from www.trickwords.com</li>
        <li>Sell, rent or sub-license material from www.trickwords.com</li>
        <li>Reproduce, duplicate or copy material from www.trickwords.com</li>
        <li>Redistribute content from www.trickwords.com</li>
      </ul>
      ...
      <p>
        ...
        www.trickwords.com does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of www.trickwords.com,its agents and/or affiliates.
        ...
        www.trickwords.com shall not be liable for the Comments or for any
      ...
      <p>
        www.trickwords.com reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant www.trickwords.com a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of www.trickwords.com; and (d) the
      ...
      <p>
        ...
        e-mail to www.trickwords.com. Please include your name, your
      ...
      <p>
        No use of www.trickwords.com's logo or other artwork will be allowed for
