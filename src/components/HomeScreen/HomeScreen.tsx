  ...
  return (
    <div className={styles.howToPlayContainer}>
      <p tabIndex={0}>
        ...
        friends locally, or with players from all over the world, you're in for
        a treat.
      </p>
      ...
      <ol>
        ...
        <li>
          ...
          you lose the round (for example, 'AB' is contained in many words so
          would pass, but if you spelled 'CAB' you would lose the round).
        </li>
        <li>
